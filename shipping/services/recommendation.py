...
REASON_LABELS = {
    ...
    "item_does_not_fit": "At least one product cannot fit in the internal dimensions, even after rotation.",
    "packing_failed": "The products could not be packed together within the internal dimensions.",
}
